...
public class Mainpt2 {
        ...
        int choice;
         ...
         do {
            ...
            switch (choice) {
                ...
                case 6 -> updateCustomer(customers, scanner);
    ...
    private static void updateCustomer(ArrayList<Customer> customers, Scanner scanner) {
    System.out.print("Enter Customer Name: ");
    String name = scanner.nextLine();
    Customer selectedCustomer = findCustomerByName(customers, name);
    ...
    if (selectedCustomer == null) {
        ...
        switch (choice) {
            case 1 -> {
                ...
                selectedCustomer.setNama(newName);
                System.out.println("Customer name updated successfully.");
            }
            case 2 -> {
                System.out.print("Enter new address: ");
                String newAddress = scanner.nextLine();
                selectedCustomer.setAlamat(newAddress);
                System.out.println("Customer address updated successfully.");
            }
            case 3 -> {
                System.out.print("Enter new phone: ");
                String newPhone = scanner.nextLine();
                selectedCustomer.setTelepon(newPhone);
